...
<body>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-9 col-md-8">
                                ...
                                <p class="lead text-muted">Listado De Inventario</p>
    <?php
    ...
    if($sql !== false){
        if(mysqli_num_rows($sql)> 0){
            ...
            echo "<table><tr><th>Id_Inventario</th><th>Id_Producto</th><th>Cantidad</th><th>FechaCreacion</th><th>FechaActualizacion</th><th>Actualizar</th><th>Eliminar</th></tr>";
            ...
            <input type='hidden' name='id_inventario' value='".$mostrar['id_inventario']."'>
            ...
            <td><form method='post' action='eliminarInventario.php'>
            <input type='hidden' name='id_inventario' value='".$mostrar['id_inventario']."'>
            <button type='submit' class='a button3' onclick='return confirm(\"¿Estás seguro de que quieres eliminar este Inventario?\")'>Eliminar</button>
        </form></td></tr>";
            }
            echo "</table>";
...
<script>
    function paginaRegistro(){
        window.location = "crearInventario.php";
    }
</script>
