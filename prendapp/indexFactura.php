   ...
   <div id="content" class="bg-grey w-100">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9 col-md-8">
                    ...
                    <p class="lead text-muted">Listado De Facturas</p>
    <?php
    ...
    if($sql !== false){
        if(mysqli_num_rows($sql)> 0){
            ...
            echo "<table><tr><th>Id_factura</th><th>Id_venta</th><th>fechaCreacion</th><th>TotalCompra</th><th>CantidadProductos</th><th>Detalles</th><th>Actualizar</th><th>Eliminar</th></tr>";
