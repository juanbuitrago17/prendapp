    ...
    if($sql !== false){
        if(mysqli_num_rows($sql)> 0){
          ?>
            ...
            <button  type='submit'  style='border:none;' class='a button3' onclick='return confirm(\"¿Estás seguro de que quieres actualizar este Producto?\")'>Actualizar</button>
            </form></td>
...
<script> $('#usuario thead th').each( function () {
        var title = $('#usuario tfoot th').eq( $(this).index() ).text();
